...
public class Vjezba_07_1 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet Vjezba_07_1</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet Vjezba_07_1 at " + request.getContextPath() + "</h1>");
            String korisnickoIme = this.getInitParameter("korisnickoIme");
            String lozinka = this.getInitParameter("lozinka");
            out.println("Korisničko ime:" + korisnickoIme + "</br>");
            out.println("Lozinka:" + lozinka + "</br>");
            out.println("</body>");
            out.println("</html>");
        }
    }
