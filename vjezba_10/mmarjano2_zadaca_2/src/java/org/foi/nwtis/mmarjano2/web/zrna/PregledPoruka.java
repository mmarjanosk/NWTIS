...
public class PregledPoruka {
    ...
    int pozicijaOdPoruke = ukupnoPorukaMapa - brojPrikazanihPoruka + 1;
    int pozicijaDoPoruke = ukupnoPorukaMapa;
...
//            folder.open(Folder.READ_WRITE);
    ...
    void preuzmiPoruke(String mapa) throws NoSuchProviderException, MessagingException, IOException {
        ...
        if (pozicijaOdPoruke <= 0) {
            ...
            if (pozicijaDoPoruke == ukupnoPorukaMapa) {
                ...
                pozicijaDoPoruke = ukupnoPorukaMapa % brojPrikazanihPoruka;
            }
            setMax(true);
        } else {
            setMax(false);
        ...
        if (folder.getMessageCount() > 0) {
            messages = folder.getMessages(pozicijaOdPoruke, pozicijaDoPoruke);
        }
    ...
    public String promjenaMape() throws MessagingException, NoSuchProviderException, IOException {
        ...
        this.pozicijaOdPoruke = ukupnoPorukaMapa - brojPrikazanihPoruka;
        this.pozicijaDoPoruke = ukupnoPorukaMapa;
        this.str = 1;
    ...
    public String prethodnePoruke() throws MessagingException, NoSuchProviderException, IOException {
        if (!min) {
            this.str--;
            this.pozicijaDoPoruke = this.ukupnoPorukaMapa + brojPrikazanihPoruka * str;

            this.pozicijaOdPoruke = this.ukupnoPorukaMapa + brojPrikazanihPoruka * str;
    ...
    public String sljedecePoruke() throws MessagingException, NoSuchProviderException, IOException {
        if (max) {
            System.out.println("druga greška");
        } else {
            this.str++;
